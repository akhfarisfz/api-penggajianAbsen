...
const KaryawanMiddlewareCreate = LibValidationsMiddleware(
  ...
  LibValidationFields.NumberField({ field: "golongan.tunjangan" }),
  ...
  LibValidationFields.NumberField({ field: "absensi.Izin",min:0 }),
  LibValidationFields.NumberField({ field: "absensi.Sakit",min:0 }),
