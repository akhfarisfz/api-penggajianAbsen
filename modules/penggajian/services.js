...
const PenggajianCreatepotonganAbsen = (req) => {
    const jumlahAlpa = nominalAlpa(req.cleanedData.karyawan.absensi.Alpa,req.cleanedData.karyawan.jabatan.gajiPokok);
    const jumlahTerlambat = nominalTerlambat(req.cleanedData.karyawan.absensi.Terlambat,req.cleanedData.karyawan.jabatan.gajiPokok);
...
const penggajianTotalPotonganCreate = (req) => {
    ...
    const totalpotongan = HitungPotonganAbsenPajak(req.cleanedData.karyawan.absensi.jumlahpotonganAbsensi, potonganpajak);
...
const penggajianGajiBersihCreate = (req) => {
    const totalGaji = HitungGajiTotal(req.cleanedData.karyawan.jabatan.gajiPokok, req.cleanedData.karyawan.jabatan.tunjangan);
    const TotalPajak=totalPajak(req);
    const TotalPotongan = HitungPotonganAbsenPajak(req.cleanedData.karyawan.absensi.jumlahpotonganAbsensi,TotalPajak);
